...
if ( ! function_exists( 'globalstudy_demo_import_files' ) ) {
    function globalstudy_demo_import_files() {
            ...
            array(
                ...
                'import_file_url' => 'https://globalstudy.stylemixthemes.com/wp-content/demo-files/demo.xml',
                'import_widget_file_url' => 'https://globalstudy.stylemixthemes.com/wp-content/demo-files/demo.wie',
                'import_customizer_file_url' => 'https://globalstudy.stylemixthemes.com/wp-content/demo-files/demo.dat',
                'preview_url' => 'https://globalstudy.stylemixthemes.com/',
            ),
        );
            return $demo;
    }
